...
export const GithubIcon = ({ width = 16, height = 16, className }: IIcon) => {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      viewBox='0 0 15 15'
...
export const ChatIcon = ({ width = 18, height = 18, className }: IIcon) => {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      viewBox='0 0 18 18'
...
export const PhoneIcon = ({ width = 16, height = 16, className }: IIcon) => {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      viewBox='0 0 24 24'
...
export const BellIcon = ({ width = 16, height = 16, className }: IIcon) => {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      viewBox='0 0 24 24'
